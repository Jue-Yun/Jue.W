  ...
  <div class="login" :style="backgroundStyle">
    <div class="area">
      ...
      <div class="box">
        ...
        <div class="form">
          <div class="line">
            <el-input v-model="userName" placeholder="用户名" :disabled="false" :clearable="true" prefix-icon="User"
              ref="inputUser" @keyup.enter="onPassword()" />
          </div>
          <div class="line">
            <el-input v-model="userPwd" placeholder="密码" :disabled="false" :clearable="true" :show-password="true"
              prefix-icon="Lock" ref="inputPassword" @keyup.enter="onLogin()" />
          </div>
          <div class="line">
            <div class="left link">
